                ...
                <section className=" min-h-screen ">
                    ...
                    <div className="sm:py-10">
                        ...
                        <p className="text-md py-5 leading-8 dark: md:text-xl max-w-6xl">
                            ...
                            developers. I'm currently looking for a full time software engineering position for January 2024. If you're interested in working together, feel free to reach out via <span className="text-green-500"> <a href="mailto:maxgpugh01@gmail.com">email</a></span>
