                ...
                <section className=" min-h-screen ">
                    <nav className=" mb-12 flex justify-between">
                        ...
                        <ul className="flex items-center">
                            ...
                            <span className="hover:translate-x-1 duration-100">
                                <li className=" p-2 rounded-s-xl bg-gradient-to-br from-purple-600 to-purple-100 text-gray-700 ml-8 cursor-pointer lg:p-4 lg:text-xl font-mulish">
                                    <a
                                        className=" "
                    ...
                    <div className="text-left pt-10 sm:px-10">
                        ...
                        <p className="leading-10 md:leading-10 text-md py-5 md:text-xl sm:max-w-4xl">
                    ...
                    <div className="max-w-6xl pt-4 px-xl m-auto ">
                        ...
                        <div className="basis-1/3 flex-1 py-5">
                            <div className="hover:translate-x-1 duration-100">
                                <a href="https://github.com/mpughcs/Notation">
                                    <BiLinkExternal className="text-2xl text-purple-600 absolute translate-y-5 translate-x-4" />
                                </a>
                            </div>
                        ...
                        <div className="flex justify-end hover:translate-x-1 duration-100">
                            <button
                                className="p-2  rounded-s-xl left-full bg-gradient-to-br from-purple-600 to-purple-100 text-gray-700 ml-8 cursor-pointer lg:p-4 lg:text-xl font-mulish"
